...
For testing authentication use queries "signup" and "login" .For realtime subscription the client  opens up a long-lived connection to the server by sending a subscription query "newLink" that specifies event: new message which appearance on board.
